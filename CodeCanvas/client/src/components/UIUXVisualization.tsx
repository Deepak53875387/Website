...
const skills: Skill[] = [
  ...
  { name: "User Interface Design", level: 90, color: "chart-2" },
  { name: "User Experience Research", level: 88, color: "chart-3" },
  { name: "Wireframing & Prototyping", level: 92, color: "chart-1" },
  { name: "Design Systems", level: 85, color: "chart-2" },
  { name: "Accessibility (A11y)", level: 87, color: "chart-3" },
  { name: "Interaction Design", level: 89, color: "chart-1" },
];
...
export function UIUXVisualization() {
  return (
    <section className="py-20 px-6 relative overflow-hidden" data-testid="section-uiux">
      <div className="absolute inset-0 dot-pattern opacity-20 pointer-events-none"></div>
      
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="mb-12 text-center animate-fade-in">
          <h2 className="text-3xl md:text-4xl font-bold mb-4" data-testid="heading-uiux">
            <span className="text-chart-2 font-mono">//</span> UI/UX Design & Strategy
          </h2>
          <div className="h-1 w-20 bg-chart-2 mx-auto"></div>
          <p className="mt-4 text-muted-foreground max-w-2xl mx-auto">
            Creating intuitive, accessible, and user-centered digital experiences
          </p>
        </div>
