...
const skills: Skill[] = [
  { name: "Technical Architecture", level: 85, color: "chart-1" },
  { name: "System Architecture", level: 88, color: "chart-2" },
  { name: "API Development", level: 90, color: "chart-3" },
  { name: "API Integration", level: 92, color: "chart-1" },
  { name: "Database Design", level: 87, color: "chart-2" },
  { name: "Cloud Infrastructure", level: 85, color: "chart-3" },
  { name: "Code Optimization", level: 89, color: "chart-1" },
  { name: "DevOps & CI/CD", level: 86, color: "chart-2" },
  { name: "System Design", level: 83, color: "chart-3" },
];
...
export function TechnicalEngineeringVisualization() {
  return (
    <section className="py-20 px-6 relative overflow-hidden" data-testid="section-technical-engineering">
      <div className="absolute inset-0 dot-pattern opacity-20 pointer-events-none"></div>
      
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="mb-12 text-center animate-fade-in">
          <h2 className="text-3xl md:text-4xl font-bold mb-4" data-testid="heading-technical-engineering">
            <span className="text-chart-2 font-mono">//</span> Technical Engineering
          </h2>
          <div className="h-1 w-20 bg-chart-2 mx-auto"></div>
          <p className="mt-4 text-muted-foreground max-w-2xl mx-auto">
            Building scalable, robust, and high-performance technical solutions
          </p>
        </div>
